...
cleanup_options() {
    read -p $'\n\e[1;35m Do you want to clean unnecessary logs? -e -i y: \e[0m' clean_logs
    read -p $'\e[1;35m Do you want to clean cache files? -e -i y: \e[0m' clean_cache
    read -p $'\e[1;35m Do you want to clean cached packages? -e -i y: \e[0m' clean_packages
    read -p $'\e[1;35m Do you want to remove unnecessary or unused packages? -e -i y: \e[0m' clean_unused_packages
    read -p $'\e[1;35m Do you want to clean temporary files? -e -i y: \e[0m' clean_temp
    read -p $'\e[1;35m Do you want to clean temporary backup files? -e -i y: \e[0m' clean_temp_backup
}
